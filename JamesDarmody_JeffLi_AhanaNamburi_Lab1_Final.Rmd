...
- **Odds Ratios** : Based on the above, we observe that the odds of success (Failure of O-Ring) change by 1.261 for every degree change in temperature. Lower Temperatures increase the probability of failure of O-Ring. We also observe this in graph generated in part 3b, where the probability of failure consistently drops with an increase in temperature. Given our lowest observed temperature is 53 degrees in the dataset, we observe that probability of failure is 1 at 31 degrees which is also the temperature at which Challenger was launched. 
