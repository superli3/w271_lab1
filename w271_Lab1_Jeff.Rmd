...
challenger<-read.table(file = "/Users/jeff/Documents/MIDS/W271/w271_lab1/challenger.csv", header = TRUE, sep = ",") #Import table
summary(challenger)
challenger
...
knitr::kable(
  challenger[1:6,1:5 ], caption = 'Top 6 Rows of Challenger Dataset')


# Distribution of log(wage)
ggplot(challenger, aes(x = lwg)) +
